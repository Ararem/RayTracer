...
)
{
	...
	/// </exception>
	public static CameraRecord Create(Vector3 lookFrom, Vector3 lookTowards, Vector3 upVector, float verticalFov, float aspectRatio, float lensRadius, float focusDistance)
	{
