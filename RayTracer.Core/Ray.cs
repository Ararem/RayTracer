...
/// <remarks>
///  Although it is assumed that the <see cref="Direction"/> is normalised, this may not be the case, so be sure to call
...
public readonly record struct Ray(Vector3 Origin, Vector3 Direction)
{
	...
	/// <summary>Returns a copy of the current ray with the <see cref="Direction"/> vector normalized</summary>
