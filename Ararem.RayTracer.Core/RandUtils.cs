...
/// <summary>A class for getting random numbers</summary>
...
public static class RandUtils
{
	...
	/// <summary>Returns a vector that has (X,Y) such that X and Y are within a circle of radius 1</summary>
	[MustUseReturnValue]
	...
	/// <summary>Returns a random colour, where the output colour has RGB values in the range [0...1]</summary>
	[MustUseReturnValue]
	public static Colour RandomColour() => RandomColour(Colour.Black, Colour.White);

	/// <summary>
	///  Returns a random colour, where the output colour is somewhere between the RGB values of the <paramref name="min"/> and
