...
/// <param name="DropoffPower">Value that controls how much values are biased. Should be &lt;1. Noise values are raised to this power before being processed into a colour. Increasing this increases the 'sharpness' of the texture and how thin the accent lines are</param>
